        ...
        <div className="modal">
          ...
          <button
            ...
            <span className="text-3xl font-bold text-white dark:text-white">${productoSeleccionado.precio}</span>
            {
                ...
                <div className="mt-2">
                <a href={`https://wa.me/5493525303250?text=Hola%20Malkiran!%20Quisiera%20saber%20m%C3%A1s%20sobre%20el%20producto%20llamado%20${productoSeleccionado.nombre}`} target="_blank" rel="noreferrer">
