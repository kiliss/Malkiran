          ...
          <button
            ...
            {/* <img className="rounded-t-lg mt-10" src={productoSeleccionado.imagen[0]} width="750px" height="750px" alt="product"/> */}
            {
                ...
                <div className="flex flex-row justify-center">
                    ...
                    <GrLinkPrevious className="fixed left-4 bg-white/70 rounded w-8 h-8"/>
                    </button>
                    <img src={photo} className="rounded-t-lg mt-10" width="750px" height="750px" alt="product"/>
                    <button onClick={nextImage}>
                    <GrLinkNext className="fixed right-4 bg-white/70 rounded w-8 h-8"/>
                    </button>
                </div>
